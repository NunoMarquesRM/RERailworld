...
function OnBuilt(event)
	...
	if entity and entity.valid then
		if entity.name == "eletric-provider" and entity.type == "electric-energy-interface" then
			table.insert(global.ProviderList,entity)
		elseif entity.name:find("locomotive-eletric-r",1,true) and entity.type == "locomotive" then 
